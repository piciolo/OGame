        ...
        <div id="traderOverview">
            <div id="inhalt">
                <div id="planet" style="background-position: 0px 0px; height: 250px;" class="detail">
                    ...
                    @endif
                    {{-- OGame ufficiale keeps the 4 trader_link entries as hidden DOM
                         placeholders on every sub-page (display:none). The visible
                         page chrome is the #header_text title + back button. --}}
                ...
                <div id="div_traderResources" class="div_trader" style="">
                    ...
                    <div class="big_tabs content ui-tabs ui-corner-all ui-widget ui-widget-content">
                        <ul role="tablist" class="ui-tabs-nav ui-corner-all ui-helper-reset ui-helper-clearfix ui-widget-header">
                            <li class="big_tab ui-tabs-tab ui-corner-top ui-state-default ui-tab ui-tabs-active ui-state-active" role="tab" tabindex="0" aria-controls="tabs-buyResource" aria-labelledby="ui-id-7" aria-selected="true" aria-expanded="true">
                                <a href="#tabs-buyResource" role="presentation" tabindex="-1" class="ui-tabs-anchor" id="ui-id-7">
                                    {{ __('t_merchant.buy_resources') }}
                                </a>
                            </li>
                            <li class="big_tab ui-tabs-tab ui-corner-top ui-state-default ui-tab" role="tab" tabindex="-1" aria-controls="tabs-changeResource" aria-labelledby="ui-id-8" aria-selected="false" aria-expanded="false">
                        ...
                        @include('ingame.merchant._buy-resources-tab', [
                            'darkMatter' => $darkMatter,
                            'buyPackages' => $buyPackages,
                        ])

                        <div id="tabs-changeResource" class="big_tab_content ui-tabs-panel ui-corner-bottom ui-widget-content" aria-labelledby="ui-id-8" role="tabpanel" aria-hidden="true" style="display:none;">
