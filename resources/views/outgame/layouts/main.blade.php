...
<div id="footer">
    ...
    .lang-flag-zh-TW { background-image: url('/img/flags/zh-TW.svg'); }
    .lang-flag-cs { background-image: url('/img/flags/cs.svg'); }
    .lang-flag-da { background-image: url('/img/flags/da.svg'); }
    .lang-flag-el { background-image: url('/img/flags/el.svg'); }
    .lang-flag-es { background-image: url('/img/flags/es.svg'); }
    .lang-flag-es_AR { background-image: url('/img/flags/es_AR.svg'); }
    .lang-flag-es_MX { background-image: url('/img/flags/es_MX.svg'); }
    ...
    .lang-flag-pt_BR { background-image: url('/img/flags/pt_BR.svg'); }
    ...
    .lang-flag-sl { background-image: url('/img/flags/sl.svg'); }
    .lang-flag-sr { background-image: url('/img/flags/sr.svg'); }
