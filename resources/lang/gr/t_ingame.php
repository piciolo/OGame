...
Combat simulation save slots +20',
    ...
    'admin' => [
        ...
        'menu_fleet_timing' => 'Χρονισμός στόλου',
        'menu_server_administration' => 'Διαχείριση διακομιστή',
        'menu_rules_legal' => 'Rules & Legal',
        'title' => 'Ρυθμίσεις σέρβερ',
        ...
        'weight_dm' => 'Σκοτεινή Ύλη',
        'weight_merchant' => 'Έμπορος',
        'weight_items' => 'Αντικείμενα',
        ...
        'dev_coordinates' => 'Συντεταγμένες',
        'dev_galaxy' => 'Γαλαξίας',
        'dev_system' => 'Σύστημα',
        'dev_position' => 'Θέση',
        'dev_resources_label' => 'Πόροι',
    ...
    'characterclass' => [
        ...
        'choose_your_class' => 'Επίλεξε την κλάση σου',
        'choose_description' => 'Επίλεξε μια κλάση, για να αποκτήσεις επιπλέον προνόμια. Μπορείς να αλλάξεις την κλάση σου στην επιλογή κλάσεων επάνω δεξιά.',
    ...
    'fleet_templates' => [
        ...
        'delete_tooltip' => 'Διαγραφή προτύπου/εισόδου',
