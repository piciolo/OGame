...
Combat simulation save slots +20',
    ...
    'admin' => [
        ...
        'menu_fleet_timing' => 'フリートタイミング',
        'menu_server_administration' => 'サーバー管理',
    ...
    'characterclass' => [
        'page_title' => 'クラスの選択',
        'choose_your_class' => 'クラスを選択する',
        'choose_description' => 'クラスを選んで、追加の特典をもらおう。右上にある「クラスの選択」からクラスを変更することができます。',
    ...
    'fleet_templates' => [
        ...
        'delete_tooltip' => 'テンプレート / 入力の削除',
        'save_tooltip' => 'テンプレートの保存',
