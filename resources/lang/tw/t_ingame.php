...
Combat simulation save slots +20',
    ...
    'admin' => [
        ...
        'menu_fleet_timing' => '艦隊計時',
        'menu_server_administration' => '伺服器管理',
    ...
    'characterclass' => [
        'page_title' => '等級選擇',
        'choose_your_class' => '選擇您的等級',
        'choose_description' => '選擇一個等級，以接收額外的好處。您可透過右上方的等級選項更改您的等級。',
