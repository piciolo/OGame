...
Combat simulation save slots +20',
    ...
    'admin' => [
        ...
        'weight_dm' => 'Тёмная материя',
        'weight_merchant' => 'Скупщик',
        'weight_items' => 'Предметы',
        ...
        'dev_coordinates' => 'Координаты',
        'dev_galaxy' => 'Галактика',
        'dev_system' => 'Солнечная система',
        'dev_position' => 'Позиция',
        'dev_resources_label' => 'Сырьё',
    ...
    'characterclass' => [
        ...
        'choose_description' => 'Выберите класс для получения дополнительных бонусов Вы можете изменить класс в панели выбора класса в правом верхнем углу',
    ...
    'fleet_templates' => [
        ...
        'template_name_label' => 'Имя',
        'delete_tooltip' => 'Удалить шаблон/ввод',
