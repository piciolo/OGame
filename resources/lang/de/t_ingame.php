...
return [
    ...
    'premium' => [
        ...
        'officer_commander_description'  => 'Der Commander hat in der modernen Kriegsführung eine wichtige Rolle übernommen. Die gestraffte Befehlsstruktur ermöglicht eine schnellere Informationsverarbeitung. Mit dem Commander behältst du dein gesamtes Imperium unter Kontrolle!',
        ...
        'officer_commander_benefit_favourites'    => 'Favoriten im gesamten Imperium verwalten',
        'officer_commander_benefit_queue'         => 'Zusätzlicher Baulistenplatz',
        'officer_commander_benefit_scanner'       => 'Imperiumsübersicht-Scanner',
        'officer_commander_benefit_ads'           => 'Keine Werbung',

        'officer_admiral_title'                   => 'Admiral',
        'officer_admiral_description'             => 'Der Admiral ist ein erfahrener Veteran und ausgezeichneter Stratege. Selbst in den härtesten Schlachten behält er den Überblick und bleibt in Kontakt mit den ihm unterstellten Admirälen.',
        ...
        'officer_admiral_benefit_fleet_slots'     => '+1 Flottenslot',
        'officer_admiral_benefit_expeditions'     => 'Rohstoffprioritäten nach einem Angriff festlegen',
        'officer_admiral_benefit_escape'          => 'Flottenfluchmodus',
        'officer_admiral_benefit_save_slots'      => '+20 Kampfsimulator-Speicherplätze',

        'officer_engineer_title'                  => 'Ingenieur',
        'officer_engineer_description'            => 'Der Ingenieur ist auf Energie- und Verteidigungsmanagement spezialisiert. In Friedenszeiten erhöht er die von Planeten produzierte Energie. Im Falle eines feindlichen Angriffs reduziert er die Verteidigungsverluste.',
        'officer_engineer_benefits'               => '+10% Energie auf allen Planeten, 50% der zerstörten Verteidigungsanlagen überleben den Kampf.',
        'officer_engineer_benefit_defence'        => '50% der zerstörten Verteidigungsanlagen überleben den Kampf',
        'officer_engineer_benefit_energy'         => '+10% Energie auf allen Planeten',

        'officer_geologist_title'                 => 'Geologe',
        'officer_geologist_description'           => 'Der Geologe ist Experte für Astromineralogie und Kristallographie. Mit geeigneter Ausrüstung ist er in der Lage, ausgezeichnete Vorkommen zu lokalisieren und den Minenertrag zu steigern.',
        'officer_geologist_benefits'              => '+10% Produktion von Metall, Kristall und Deuterium auf allen Planeten.',
        'officer_geologist_benefit_mines'         => '+10% Produktion von Metall, Kristall und Deuterium auf allen Planeten',

        'officer_technocrat_title'                => 'Technokrat',
        'officer_technocrat_description'          => 'Die Kooperative der Technokraten besteht aus brillanten Wissenschaftlern. Kein normaler Mensch wird je versuchen, den Code eines Technokraten zu entschlüsseln; allein durch seine Anwesenheit inspiriert er die Forscher des Imperiums.',
        'officer_technocrat_benefits'             => '-25% Forschungszeit für alle Technologien.',
        'officer_technocrat_benefit_espionage'    => 'Spionagestufe ohne Sonde sichtbar',
        'officer_technocrat_benefit_research'     => '-25% Forschungszeit für alle Technologien',

        'officer_all_officers_title'              => 'Kommandostab',
        'officer_all_officers_description'        => 'Mit diesem Paket sicherst du dir nicht nur einen Spezialisten, sondern einen kompletten Kommandostab. Du profitierst von allen individuellen Offizierseffekten sowie den exklusiven Zusatzvorteilen, die nur mit dem Komplettpaket verfügbar sind.',
        ...
        'officer_all_officers_benefit_fleet_slots' => 'Alle Flottenslot-Boni',
        'officer_all_officers_benefit_energy'     => 'Alle Energieboni',
        'officer_all_officers_benefit_mines'      => 'Alle Minenertrag-Boni',
        'officer_all_officers_benefit_espionage'  => 'Alle Spionageboni',
    ],
    ...
    'admin' => [
        ...
        'menu_server_administration'   => 'Serveradministration',
