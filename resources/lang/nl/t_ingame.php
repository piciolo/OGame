...
return [
    ...
    'achievements' => [
        ...
        'name_progress_base' => 'Basisvooruitgang',
        'name_progress_season' => 'Seizoensvooruitgang',
        'name_planet_expansion' => 'Planetaire Uitbreiding',
        'name_moon_walk' => 'Maanwandeling',
        'name_magnetism' => 'Magnetisme',
        'name_crystal_magic' => 'Kristalmagie',
        'name_fusion_fan' => 'Fusiefan',
        'name_underground' => 'Te Diep Gegraven',
        'name_clean_energy' => 'Schone Energie',
        'name_overload' => 'Overbelast',
        'name_full_house' => 'Volle Bak',
        'name_robot_revolt' => 'Robot Revolte',
        'name_lets_go' => 'Hop, Hop en Weg!',
        'name_know_it_all' => 'Betweter',
        'name_friend_helper' => 'Vriend en Helper',
        'name_small_useful' => 'Klein Maar Fijn',
        'name_creative_streak' => 'Creatieve Inslag',
        'name_jumpgate_man' => 'Dockmatic',
        'name_well_equipped' => 'Tot de Tanden Bewapend',
        'name_specialized_electronics' => 'Gecertificeerde Elektricien',
        'name_bam_bam' => 'PIEF! PIEF! PIEF!',
        'name_more_bam' => 'Nog Meer PANG!',
        'name_spacetime_anomaly' => 'Ruimte-Tijd Anomalie',
        'name_stirred_not_shaken' => 'Plasmificatie',
        'name_ship_tuning' => 'Opgevoerde Ruimteschepen',
        'name_impulse_received' => 'Behoud van Impuls',
        'name_faster_than_physics' => 'Sneller Dan de Wetten van de Fysica',
        'name_secret_strategist' => 'Geheime Meesterbrein',
        'name_nerd_corp' => 'NERD B.V.',
        'name_nobel_network' => 'Nobelprijs Netwerken',
        'name_energy_devourer' => 'Energie Aftapping',
        'name_scissors' => 'Schaar',
        'name_rock' => 'Steen',
        'name_paper' => 'Blad',
        'name_sinking' => 'Slagschepen!',
        'name_ball_pit' => 'Grote Vuurkrachtballen',
        'name_turret_builder' => 'Ruimteschildpad',
        'name_flea_market' => 'Vlooienmarkt',
        'name_flora_explora' => 'Tijdperk van Ontdekkingen',
        'name_finders' => 'Wie Het Vindt...',
        'name_keepers' => '... Mag Het Houden!',
        'name_still_good' => 'Verspillen is Verliezen!',
        'name_powerful_variety' => 'Afwisseling Maakt het Leven Leuker',
        'name_future_sight' => 'De Toekomst Lacht Je Toe',
        'name_take_it_all' => 'Neem Alles Mee!',
        'name_no_time' => 'Tijd is Kostbaar!',
        'name_into_my_hold' => 'Leg Het In Het Ruim!',
        'name_duplicating_effect' => 'Verdubbelend Effect',
        'name_quality_not_quantity' => 'Kwaliteit Boven Kwantiteit',
        'name_want_to_be_best' => 'Wees de Beste',
        'name_rising_star' => 'Rijzende Ster',
        // Descrizioni achievement (51 voci)
        'desc_progress_base' => 'Vervul alle niveaus van 10 basisprestaties (exclusief verborgen prestaties).',
        'desc_progress_season' => 'Vervul alle niveaus van 15 seizoensprestaties.',
        'desc_planet_expansion' => 'Bezit 4 planeten.',
        'desc_moon_walk' => 'Bezit 1 maan.',
        'desc_magnetism' => 'Breid een Metaalmijn uit naar niveau 20.',
        'desc_crystal_magic' => 'Breid een Kristalmijn uit naar niveau 20.',
        'desc_fusion_fan' => 'Breid een Deuterium Synthesizer uit naar niveau 20.',
        'desc_underground' => 'Bereik een totaal niveau 500 in alle Mijnen op al je planeten gecombineerd.',
        'desc_clean_energy' => 'Breid een Fusiecentrale uit naar niveau 15.',
        'desc_overload' => 'Produceer 10.000 energie op een planeet.',
        'desc_full_house' => 'Kies de Verzamelaar als jouw klasse.',
        'desc_robot_revolt' => 'Breid een Robotfabriek uit naar niveau 10.',
        'desc_lets_go' => 'Breid een Werf uit naar niveau 10.',
        'desc_know_it_all' => 'Bereik een totaal niveau 25 in alle Onderzoek Labs op al je planeten gecombineerd.',
        'desc_friend_helper' => 'Verbeter een Alliantiehangar naar niveau 10.',
        'desc_small_useful' => 'Breid een Nanorobotfabriek uit naar niveau 5.',
        'desc_creative_streak' => 'Breid een Terravormer uit naar niveau 10.',
        'desc_jumpgate_man' => 'Breid een Ruimtewerf uit naar niveau 5.',
        'desc_well_equipped' => 'Bezit een totaal van 100 raketten on eén planeet.',
        'desc_specialized_electronics' => 'Onderzoek Energietechniek naar niveau 10.',
        'desc_bam_bam' => 'Onderzoek Lasertechniek naar niveau 5.',
        'desc_more_bam' => 'Onderzoek Iontechniek naar niveau 5.',
        'desc_spacetime_anomaly' => 'Onderzoek Hyperruimtetechniek naar niveau 5.',
        'desc_stirred_not_shaken' => 'Onderzoek Plasmatechniek naar niveau 5.',
        'desc_ship_tuning' => 'Onderzoek Verbrandingsmotor naar niveau 5',
        'desc_impulse_received' => 'Onderzoek Impulsmotor naar niveau 5.',
        'desc_faster_than_physics' => 'Onderzoek Hyperruimtemotoren naar niveau 5.',
        'desc_secret_strategist' => 'Onderzoek Spionagetechniek naar niveau 10.',
        'desc_nerd_corp' => 'Onderzoek Computertechniek naar niveau 10.',
        'desc_nobel_network' => 'Onderzoek Intergalactisch Onderzoeksnetwerk naar niveau 1.',
        'desc_energy_devourer' => 'Onderzoek Gravitontechniek naar niveau 1.',
        'desc_scissors' => 'Onderzoek Wapentechniek naar niveau 10.',
        'desc_rock' => 'Onderzoek Schildtechniek naar niveau 10.',
        'desc_paper' => 'Onderzoek Pantsertechniek naar niveau 10.',
        'desc_sinking' => 'Bezit 50.000 schepen (exclusief Spionagesondes en Zonne-energiesatellieten)',
        'desc_ball_pit' => 'Bezit 100 Sterren des Doods.',
        'desc_turret_builder' => 'Bezit 10.000 verdedigingswerken on eén planeet (exclusief raketten).',
        'desc_flea_market' => 'Handel 1.000.000.000 Metaal met de Handelaar.',
        'desc_flora_explora' => 'Rond 1.000 expedities af.',
        'desc_finders' => 'Vind 10.000 schepen op expedities.',
        'desc_keepers' => 'Vind 10.000 Donkere Materie op expedities.',
        'desc_still_good' => 'Vind 100.000.000 grondstoffen (Metaal, Kristal of Deuterium) op expedities.',
        'desc_powerful_variety' => 'Verbeter een levensvorm naar niveau 10.',
        'desc_future_sight' => 'Ontgrendel alle niveau 1 levensvorm onderzoek slots op een planeet.',
        'desc_take_it_all' => 'Bereik a totaal van niveau 60 in een niveau 1 tech tree op eén planeet.',
        'desc_no_time' => 'Bereik een globale levensvorm tech bonus in Onderzoekstijd van -25%.',
        'desc_into_my_hold' => 'Verzamel 10.000 Artefacten.',
        'desc_duplicating_effect' => 'Bereik een globale levensvorm tech bonus in Metaalproductie van 100%.',
        'desc_quality_not_quantity' => 'Bereik een globale levensvorm tech bonus in Lichte Gevechtsschepen van 150%.',
        'desc_want_to_be_best' => 'Ontgrendel het niveau 18 slot van Mensen.',
        'desc_rising_star' => 'Bereik 5.000.000 topscore punten.',
    ],
