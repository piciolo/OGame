...
Combat simulation save slots +20',
    ...
    'admin' => [
        ...
        'menu_fleet_timing' => 'Flottans timing',
        ...
        'weight_dm' => 'Mörk materia',
        'weight_merchant' => 'Handelsman',
        'weight_items' => 'Objekt',
    ...
    'characterclass' => [
        'page_title' => 'Klass Val',
        'choose_your_class' => 'Välj Din Klass',
        'choose_description' => 'Välj en klass för att få ytterligare förmåner. Du kan ändra din klass i klassavsnittet högst upp till höger.',
    ...
    'fleet_templates' => [
        'name_col' => 'Namn',
        'actions_col' => 'Handling',
        'template_name_label' => 'Namn',
        'delete_tooltip' => 'Ta bort mall/inmatning',
