...
return [
    ...
    'achievements' => [
        ...
        'desc_progress_base' => 'Complete non-secret base achievements with all tiers.',
        'desc_progress_season' => 'Complete seasonal achievements with all tiers.',
        'desc_planet_expansion' => 'Own planets.',
        'desc_moon_walk' => 'Own moons.',
        'desc_magnetism' => 'Build Metal Mines to high levels.',
        'desc_crystal_magic' => 'Build Crystal Mines to high levels.',
        'desc_fusion_fan' => 'Build Deuterium Synthesizers to high levels.',
        'desc_underground' => 'Underground resources accumulated.',
        'desc_clean_energy' => 'Build Solar Plants to high levels.',
        'desc_overload' => 'Build Fusion Reactors to high levels.',
        'desc_full_house' => 'Total buildings on planets.',
        'desc_robot_revolt' => 'Build Robotic Factories to high levels.',
        'desc_lets_go' => 'Build Shipyards to high levels.',
        'desc_know_it_all' => 'Build Research Labs to high levels.',
        'desc_friend_helper' => 'Build Alliance Depots.',
        'desc_small_useful' => 'Build Missile Silos to high levels.',
        'desc_creative_streak' => 'Build Terraformers to high levels.',
        'desc_jumpgate_man' => 'Build Jump Gates to high levels.',
        'desc_well_equipped' => 'Total resources collected.',
        'desc_specialized_electronics' => 'Research electronic technologies to high levels.',
        'desc_bam_bam' => 'Research weapon technologies to high levels.',
        'desc_more_bam' => 'Research shield technologies to high levels.',
        'desc_spacetime_anomaly' => 'Research armor technologies to high levels.',
        'desc_stirred_not_shaken' => 'Research Energy to high levels.',
        'desc_ship_tuning' => 'Research propulsion technologies to high levels.',
        'desc_impulse_received' => 'Research Impulse Drive to high levels.',
        'desc_faster_than_physics' => 'Research Hyperspace Drive to high levels.',
        'desc_secret_strategist' => 'Research espionage technologies to high levels.',
        'desc_nerd_corp' => 'Research Computer Technology to high levels.',
        'desc_nobel_network' => 'Research Intergalactic Research Network to high levels.',
        'desc_energy_devourer' => 'Research Plasma and related technologies to high levels.',
        'desc_scissors' => 'Build Heavy Fighters.',
        'desc_rock' => 'Build Cruisers.',
        'desc_paper' => 'Build Battleships.',
        'desc_sinking' => 'Number of fleets destroyed.',
        'desc_ball_pit' => 'Number of probes launched.',
        'desc_turret_builder' => 'Number of defenses built.',
        'desc_flea_market' => 'Trade transfers completed.',
        'desc_flora_explora' => 'Expeditions completed.',
        'desc_finders' => 'Positive findings on expeditions.',
        'desc_keepers' => 'Resources earned from expeditions.',
        'desc_still_good' => 'Debris collected.',
        'desc_powerful_variety' => 'Number of different ship types owned.',
        'desc_future_sight' => 'Espionage of other planets.',
        'desc_take_it_all' => 'Battles won with loot.',
        'desc_no_time' => 'Speed: number of fast flights completed.',
        'desc_into_my_hold' => 'Successful transports completed.',
        'desc_duplicating_effect' => 'Planets colonized with different terrain types.',
        'desc_quality_not_quantity' => 'Planets with high size.',
        'desc_want_to_be_best' => 'Player ranking position.',
        'desc_rising_star' => 'Points accumulated.',
    ],
