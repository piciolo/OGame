...
return [
    ...
    'achievements' => [
        ...
        'name_progress_base' => 'Basic Progress',
        'name_progress_season' => 'Season Progress',
        'name_planet_expansion' => 'Planetary Expansion',
        'name_moon_walk' => 'Moonwalk',
        'name_magnetism' => 'Magnetism',
        'name_crystal_magic' => 'Crystal Magic',
        'name_fusion_fan' => 'Fusion Fan',
        'name_underground' => 'Dug Too Deep',
        'name_clean_energy' => 'Clean Energy',
        'name_overload' => 'Overload',
        'name_full_house' => 'Full House',
        'name_robot_revolt' => 'Robot Rebellion',
        'name_lets_go' => 'Up, Up and Away!',
        'name_know_it_all' => 'Know-It-All',
        'name_friend_helper' => 'Friend and Helper',
        'name_small_useful' => 'Small Is Beautiful',
        'name_creative_streak' => 'Creative Streak',
        'name_jumpgate_man' => 'Dockmatic',
        'name_well_equipped' => 'Armed to the Teeth',
        'name_specialized_electronics' => 'Certified Electrician',
        'name_bam_bam' => 'PEW! PEW! PEW!',
        'name_more_bam' => 'Even More PEW!',
        'name_spacetime_anomaly' => 'Space-Time Anomaly',
        'name_stirred_not_shaken' => 'Plasmafication',
        'name_ship_tuning' => 'Souped Up Spaceships',
        'name_impulse_received' => 'Conservation of Momentum',
        'name_faster_than_physics' => 'Faster Than the Laws of Physics',
        'name_secret_strategist' => 'Secret Mastermind',
        'name_nerd_corp' => 'NERD Corp.',
        'name_nobel_network' => 'Nobel Prize Networking',
        'name_energy_devourer' => 'Energy Drain',
        'name_scissors' => 'Scissors',
        'name_rock' => 'Rock',
        'name_paper' => 'Paper',
        'name_sinking' => 'Battleships!',
        'name_ball_pit' => 'Great Balls of Firepower',
        'name_turret_builder' => 'Space Turtle',
        'name_flea_market' => 'Flea Market',
        'name_flora_explora' => 'Age of Exploration',
        'name_finders' => 'Finders...',
        'name_keepers' => '... Keepers!',
        'name_still_good' => 'Waste Not, Want Not!',
        'name_powerful_variety' => 'Variety Is the Spice of Life',
        'name_future_sight' => 'The Future’s Bright',
        'name_take_it_all' => 'Take It All!',
        'name_no_time' => 'Time Is Precious!',
        'name_into_my_hold' => 'Put It In the Hold!',
        'name_duplicating_effect' => 'Doubling Effect',
        'name_quality_not_quantity' => 'Quality Not Quantity',
        'name_want_to_be_best' => 'Be the Best',
        'name_rising_star' => 'Rising Star',
        'desc_progress_base' => 'Complete all tiers of 10 basic achievements (excluding hidden achievements).',
        'desc_progress_season' => 'Complete all tiers of 15 season achievements.',
        'desc_planet_expansion' => 'Have 4 planets.',
        'desc_moon_walk' => 'Have 1 moon.',
        'desc_magnetism' => 'Upgrade a Metal Mine to level 20.',
        'desc_crystal_magic' => 'Upgrade a Crystal Mine to level 20.',
        'desc_fusion_fan' => 'Upgrade a Deuterium Synthesiser to level 20.',
        'desc_underground' => 'Reach a total of level 500 from the mines on all your planets combined.',
        'desc_clean_energy' => 'Upgrade a Fusion Reactor to level 15.',
        'desc_overload' => 'Produce 10,000 energy on a planet.',
        'desc_full_house' => 'Choose the Collector as your class.',
        'desc_robot_revolt' => 'Upgrade a Robotics Factory to level 10.',
        'desc_lets_go' => 'Upgrade a Shipyard to level 10.',
        'desc_know_it_all' => 'Reach a total of level 25 from the Research Labs on all your planets combined.',
        'desc_friend_helper' => 'Upgrade an Alliance Depot to level 10.',
        'desc_small_useful' => 'Upgrade a Nanite Factory to level 5.',
        'desc_creative_streak' => 'Upgrade a Terraformer to level 10.',
        'desc_jumpgate_man' => 'Upgrade a Space Dock to level 5.',
        'desc_well_equipped' => 'Have a total of 100 missiles on one planet.',
        'desc_specialized_electronics' => 'Research Energy Technology to level 10.',
        'desc_bam_bam' => 'Research Laser Technology to level 5.',
        'desc_more_bam' => 'Research Ion Technology to level 5.',
        'desc_spacetime_anomaly' => 'Research Hyperspace Technology to level 5.',
        'desc_stirred_not_shaken' => 'Research Plasma Technology to level 5.',
        'desc_ship_tuning' => 'Research the Combustion Drive to level 5.',
        'desc_impulse_received' => 'Research the Impulse Drive to level 5.',
        'desc_faster_than_physics' => 'Research the Hyperspace Drive to level 5.',
        'desc_secret_strategist' => 'Research Espionage Technology to level 10.',
        'desc_nerd_corp' => 'Research Computer Technology to level 10.',
        'desc_nobel_network' => 'Research the Intergalactic Research Network to level 1.',
        'desc_energy_devourer' => 'Research Graviton Technology to level 1.',
        'desc_scissors' => 'Research Weapons Technology to level 10.',
        'desc_rock' => 'Research Shield Technology to level 10.',
        'desc_paper' => 'Research Armour Technology to level 10.',
        'desc_sinking' => 'Own 50,000 ships (excluding Espionage Probes and Solar Satellites).',
        'desc_ball_pit' => 'Own 100 Deathstars.',
        'desc_turret_builder' => 'Have 10,000 defensive structures on one planet (excluding missiles).',
        'desc_flea_market' => 'Trade 1,000,000,000 Metal with the Merchant.',
        'desc_flora_explora' => 'Complete 1,000 expeditions.',
        'desc_finders' => 'Find 10,000 ships on expeditions.',
        'desc_keepers' => 'Find 10,000 Dark Matter on expeditions.',
        'desc_still_good' => 'Find 100,000,000 resources (Metal, Crystal or Deuterium) on expeditions.',
        'desc_powerful_variety' => 'Advance a lifeform to level 10.',
        'desc_future_sight' => 'Unlock all tier 1 lifeform research slots on a planet.',
        'desc_take_it_all' => 'Reach a total of level 60 in a tier 1 tech tree on one planet.',
        'desc_no_time' => 'Reach a global lifeform tech bonus to research time of -25%.',
        'desc_into_my_hold' => 'Collect 10,000 Artefacts.',
        'desc_duplicating_effect' => 'Reach a global lifeform tech bonus to Metal production of 100%.',
        'desc_quality_not_quantity' => 'Reach a global lifeform tech bonus to Light Fighters of 150%.',
        'desc_want_to_be_best' => 'Unlock the level 18 slot for Humans.',
        'desc_rising_star' => 'Reach 5,000,000 highscore points.',
    ],
